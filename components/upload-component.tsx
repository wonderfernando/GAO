        ...
        >
            ...
            >
                ...
                <div className=" flex flex-col items-center justify-center text-center">
                    ...
                    <Button  type="button" variant="outline" className="mt-4" onClick={(e) => { e.stopPropagation(); openFileDialog() }}>
                        <UploadIcon className="-ms-1 opacity-60" aria-hidden="true" />
                        Selecionar arquivos {false && <Loader2 className="animate-spin" />}
                    </Button>
                </div>
            </div>
                ...
                <>
                    ...
                    <div className="flex items-center justify-between gap-2">
                        <h3 className="text-sm font-medium">Ficheiros 2</h3>
                                    ...
                                    <TableRow  >
                                        <TableCell className="max-w-48 py-2 font-medium">
                                            <span className="flex items-center gap-2">
                                                ...
                                                <span className="truncate">dasd</span>
                                            </span>
                                        </TableCell>
