...
import type { MenuGroup, Role } from "./../../../config/menu";
...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white/80 w-full">
      {/* 🔹 Topbar estilo LinkedIn */}
      <Header profile={user?.tipo} username={user?.nome}></Header>

      {/* 🔹 Corpo com grid */}
      <div className="flex-1 w-full max-w-full md:max-w-7xl mx-auto mt-6 px-2 grid grid-cols-12 gap-4">
        {/* Sidebar esquerda */}
        <aside className="hidden lg:block col-span-2 space-y-4 sticky top-20 self-start max-h-[calc(100vh-6rem)] overflow-y-auto">
          ...
          <div className="bg-white p-4 rounded-lg text-sm text-gray-600 ">
            ...
            <ul className="mt-2 space-y-1">
              <li>
                <Link href="/profissional/me">tipo</Link>
              </li>
              <li>
